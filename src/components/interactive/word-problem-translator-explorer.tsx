...
const PRESETS: WordPreset[] = [
  {
    ...
    category: "Money",
    problem:
      "A shirt costs ₹15 more than a cap. Together they cost ₹55. Find the price of the cap.",
    highlights: [
      { phrase: "₹15 more than", meaning: "Add 15 to the cap's price." },
    ...
    unknownAnswer: 1,
    matchPhrase: "\u201c₹15 more than the cap\u201d",
    ...
    answer: "The cap costs ₹20 (and the shirt costs ₹35).",
  ...
  },
  {
    ...
    category: "Transport",
    problem:
      "A taxi charges a fixed ₹6 fee plus ₹2 per kilometre. A ride costs ₹24. How many kilometres was the ride?",
    highlights: [
      { phrase: "fixed ₹6 fee", meaning: "A constant charge added once." },
      { phrase: "₹2 per kilometre", meaning: "2 times the number of kilometres." },
    ],
    unknownPrompt: "What should x represent?",
    unknownOptions: ["The number of kilometres", "The total fare", "The fixed fee"],
    unknownAnswer: 0,
    matchPhrase: "\u201c₹2 per kilometre\u201d",
    matchOptions: ["x + 2", "2x", "x \u2212 2"],
    matchAnswer: 1,
    equation: "2x + 6 = 24",
  ...
  },
  {
    ...
    problem:
      "A worker is paid ₹20 for the day plus ₹8 per completed task. He earned ₹92. How many tasks did he complete?",
    highlights: [
      { phrase: "₹20 for the day", meaning: "A fixed payment added once." },
      { phrase: "₹8 per completed task", meaning: "8 times the number of tasks." },
    ],
    unknownPrompt: "What should x represent?",
    unknownOptions: ["The number of tasks completed", "The daily fixed pay", "The total pay"],
    unknownAnswer: 0,
    matchPhrase: "\u201c₹8 per completed task\u201d",
