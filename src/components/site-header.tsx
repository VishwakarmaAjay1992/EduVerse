...
import { Compass, GraduationCap, HelpCircle, Lightbulb, Microscope, Sparkles } from "lucide-react";
    ...
    <header className="sticky top-0 z-40 w-full border-b bg-background/80 backdrop-blur">
      <div className="container flex h-14 items-center justify-between">
        ...
        <nav className="flex items-center gap-1">
          ...
          <Link
            href="/history-of-human-inventions"
            className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground"
          >
            <Lightbulb className="size-4 sm:hidden" aria-hidden="true" />
