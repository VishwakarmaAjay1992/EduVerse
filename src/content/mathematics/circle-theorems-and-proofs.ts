...
export const circleTheoremsAndProofs: LessonContent = {
  ...
  "objectives": [
    "Define key vocabulary for circle theorems.",
    "Use the main formula or theorem for circle theorems.",
  ...
  "sections": [
    {
      "kind": "overview",
      "paragraphs": [
        "This lesson develops the next major idea in geometry: circle theorems. You will connect definitions, diagrams, formulas and reasoning so that the topic becomes more than a list of rules.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Important words in this lesson include: angle at centre, angle in semicircle, same segment, cyclic quadrilateral, tangent-radius. Each word names a specific part of the diagram or a specific transformation, so careful vocabulary prevents wrong calculations.",
    ...
    {
      "kind": "formula",
      "latex": "\\angle ACB=\\frac12\\angle AOB",
      "caption": "Key formula or idea for circle theorems"
    },
    {
      "kind": "table",
      ...
      "rows": [
        [
          "Angle At Centre",
          "A central idea in circle theorems",
    ...
    {
      "kind": "example",
      "prompt": "A problem gives information about angle at centre and asks for angle in semicircle. Explain the first step.",
      "steps": [
    ...
    {
      "kind": "example",
      "prompt": "Use the key idea of circle theorems to solve a missing value problem.",
      "steps": [
        "Write the rule: $\\angle ACB=\\frac12\\angle AOB$.",
    ...
    {
      "kind": "example",
      "prompt": "A student gets an answer that looks possible by eye. Why is that not enough in circle theorems?",
      "steps": [
      ...
      "items": [
        {
          ...
          "text": "Circle Theorems appears in floor plans, elevations, tiling layouts and structural drawings."
        },
        {
          "area": "Engineering",
    ...
    },
    {
      ...
      "questions": [
        {
          "prompt": "Which action should come first in a circle theorems problem?",
          "options": [
    ...
    },
    {
      ...
      "questions": [
        {
          "prompt": "The safest way to solve circle theorems problems is to:",
          "options": [
            "measure the screen",
    ...
    },
    {
      "kind": "summary",
      "points": [
        "Circle Theorems depends on precise vocabulary and diagram reading.",
