...
export const translationRotationReflectionAndEnlargement: LessonContent = {
  ...
  "objectives": [
    "Define key vocabulary for transformations.",
    "Use the main formula or theorem for transformations.",
  ...
  "sections": [
    {
      "kind": "overview",
      "paragraphs": [
        "This lesson develops the next major idea in geometry: transformations. You will connect definitions, diagrams, formulas and reasoning so that the topic becomes more than a list of rules.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Important words in this lesson include: translation, rotation, reflection, enlargement, scale factor. Each word names a specific part of the diagram or a specific transformation, so careful vocabulary prevents wrong calculations.",
    ...
    },
    {
      "kind": "formula",
      "latex": "(x,y)\\to(x+a,y+b)",
      "caption": "Key formula or idea for transformations"
    },
    {
      "kind": "table",
      ...
      "rows": [
        [
          "Translation",
          "A central idea in transformations",
    ...
    {
      "kind": "example",
      "prompt": "A problem gives information about translation and asks for rotation. Explain the first step.",
      "steps": [
    ...
    {
      "kind": "example",
      "prompt": "Use the key idea of transformations to solve a missing value problem.",
      "steps": [
        "Write the rule: $(x,y)\\to(x+a,y+b)$.",
    ...
    {
      "kind": "example",
      "prompt": "A student gets an answer that looks possible by eye. Why is that not enough in transformations?",
      "steps": [
      ...
      "items": [
        {
          ...
          "text": "Transformations appears in floor plans, elevations, tiling layouts and structural drawings."
        },
        {
          "area": "Engineering",
    ...
    },
    {
      ...
      "questions": [
        {
          "prompt": "Which action should come first in a transformations problem?",
          "options": [
    ...
    },
    {
      ...
      "questions": [
        {
          "prompt": "The safest way to solve transformations problems is to:",
          "options": [
            "measure the screen",
    ...
    },
    {
      "kind": "summary",
      "points": [
        "Transformations depends on precise vocabulary and diagram reading.",
