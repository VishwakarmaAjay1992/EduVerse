...
export const interiorAndExteriorAnglesOfPolygons: LessonContent = {
  ...
  "objectives": [
    "Define key vocabulary for polygons.",
    "Use the main formula or theorem for polygons.",
  ...
  "sections": [
    {
      "kind": "overview",
      "paragraphs": [
        "This lesson develops the next major idea in geometry: polygons. You will connect definitions, diagrams, formulas and reasoning so that the topic becomes more than a list of rules.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Important words in this lesson include: regular polygon, interior angle, exterior angle, sum formula, turning angle. Each word names a specific part of the diagram or a specific transformation, so careful vocabulary prevents wrong calculations.",
    ...
    },
    {
      ...
      "caption": "Key formula or idea for polygons"
    },
    {
      "kind": "table",
    ...
    {
      "kind": "example",
      "prompt": "A problem gives information about regular polygon and asks for interior angle. Explain the first step.",
      "steps": [
    ...
    {
      "kind": "example",
      "prompt": "Use the key idea of polygons to solve a missing value problem.",
      "steps": [
        "Write the rule: $(n-2)\\times180^\\circ$.",
    ...
    {
      "kind": "example",
      "prompt": "A student gets an answer that looks possible by eye. Why is that not enough in polygons?",
      "steps": [
      ...
      "items": [
        {
          ...
          "text": "Polygons appears in floor plans, elevations, tiling layouts and structural drawings."
        },
        {
          "area": "Engineering",
    ...
    },
    {
      ...
      "questions": [
        {
          "prompt": "Which action should come first in a polygons problem?",
          "options": [
    ...
    },
    {
      ...
      "questions": [
        {
          "prompt": "The safest way to solve polygons problems is to:",
          "options": [
            "measure the screen",
    ...
    },
    {
      "kind": "summary",
      "points": [
        "Polygons depends on precise vocabulary and diagram reading.",
